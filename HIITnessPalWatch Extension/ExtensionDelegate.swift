...
class ExtensionDelegate: NSObject, WKExtensionDelegate {
    ...
    func applicationDidFinishLaunching() {
        ...
        print("----")
        print("Setup userToggledHealthKitObserver")
    ...
    @objc func setupHeartRateObserver(notification: NSNotification) {
        print("Running setupHeartRateObserver function")
        ...
        if isEnabled {
            ...
            print("Stopping heartRateObserver")
            HealthKitController.sharedInstance.stopHeartRateObserver()
        }
    }
